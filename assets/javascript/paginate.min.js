...
(function(window){
    ...
    function lignePaginate(){
        ...
        var pageButtons = function(numberOfPage,currentPage) {
             ...
             **/
            let buttons = "<button class='displayButton green' onmousedown='paginate.sort("+(currentPage - 1)+")'  "+prevDisabled+">Prev </button>";
            let buttonNumberOfPage = "<span style='font-size: 14pt; font-weight: 500;'> Current Page: " + currentPage + ' of ' + numberOfPage + "</span>";

            for (let $i=1; $i<=numberOfPage;$i++){
                if(numberOfPage > 10){
                    buttons += paginationMoreThatTenPage($i,numberOfPage);
                }else{
                    buttons += "<button class='displayButton blue' style='margin:0vh 0.5vw;' id='id"+$i+"' onmousedown='paginate.sort("+$i+")'> "+$i+" </button>";
                }
            }
            let nextButton = "<button class='displayButton green' style='margin:0vh 0.5vw;'   onclick='paginate.sort("+(currentPage + 1)+" )"+nextDisabled+"'>Next</button>";
            buttons +=  nextButton;
        ...
        var paginationMoreThatTenPage = function(iterator,numberOfPage){
            ...
            if(iterator > referenceForTheLast || iterator < 5){
                return "<button id='id"+iterator+"' class='displayButton blue' style='margin:0vh 0.5vw;' onclick='paginate.sort("+iterator+")'>"+iterator+"</button>";
            }else if((iterator + 1) == numberOfPage) {
                return middleValue + "<button id='id"+iterator+"' class='displayButton blue' style='margin:0vh 0.5vw;display: none' onclick='paginate.sort("+iterator+")'>"+iterator+" </button>";
            }else {
                return "<button id='id"+iterator+"' class='displayButton blue' style='display: none;margin:0vh 0.5vw;' onclick='paginate.sort("+iterator+")'>"+iterator+"</button>";
            }
        }
